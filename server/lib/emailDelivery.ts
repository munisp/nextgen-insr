...
const SMTP_FROM = process.env.SMTP_FROM || "InsurePortal <noreply@insureportal.com>";
...
<body style="margin:0;padding:0;background:#f4f4f7;font-family:Arial,sans-serif;">
  <div style="max-width:600px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;margin-top:20px;">
    <div style="background:#1e40af;color:#fff;padding:24px;text-align:center;">
      <h1 style="margin:0;font-size:24px;">InsurePortal</h1>
...
<body style="margin:0;padding:0;background:#f4f4f7;font-family:Arial,sans-serif;">
  <div style="max-width:400px;margin:20px auto;background:#fff;border-radius:8px;overflow:hidden;">
    ...
    <div style="background:#f4f4f7;padding:12px;text-align:center;font-size:11px;color:#999;">InsurePortal — Thank you for your transaction</div>
  </div>
</body>
</html>`;
}
