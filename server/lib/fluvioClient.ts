...
/**
 * InsurePortal Shell — Fluvio Streaming Client
 *
 ...
 *
 * Architecture:
 *   Insurance Portal → fluvioClient.produce() → Fluvio cluster → consumers (fraud engine,
...
/** Well-known topics this Insurance Portal produces to or consumes from */
