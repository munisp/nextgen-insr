...
export const ENV = {
  ...
  kafkaClientId: process.env.KAFKA_CLIENT_ID ?? "platform-shell",
  ...
  keycloakClientId: process.env.KEYCLOAK_CLIENT_ID ?? "platform-shell",
  ...
  otelServiceName: process.env.OTEL_SERVICE_NAME ?? "platform-shell",
