...
describe("Sprint 16: Partner Onboarding Router", () => {
  ...
  it("should have all onboarding step procedures", async () => {
    ...
    expect(procedures).toContain("addRegion");
    ...
    expect(procedures).toContain("listRegions");
    expect(procedures).toContain("listFees");
    expect(procedures).toContain("removeRegion");
...
describe("Sprint 16: Schema Tables", () => {
  it("should have invite_codes, tenant_branding, tenant_regions, tenant_fee_overrides in schema", async () => {
    const fs = await import("fs");
    ...
    expect(content).toContain("tenantRegions");
