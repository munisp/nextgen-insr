 ...
 * ═══════════════════════════════════════════════════════════════════════════
 * REASON: services/rust/ddos-shield and services/go/pbac-engine were never merged.
 * EVIDENCE: path-commit API: 0 commits (2026-08-16).
 * RE-ENABLE CONDITION: Both services exist on main with asserted content and are wired into CI.
