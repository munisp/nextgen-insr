...
export const platformCapacityPlannerRouter = router({
  ...
  getStats: protectedProcedure.query(async () => {
    throw new TRPCError({
      ...
      message: "Capacity planner stats are not implemented yet",
    });
  }),
  ...
  listResources: protectedProcedure.query(async () => {
    throw new TRPCError({
      code: "NOT_IMPLEMENTED",
      message: "Capacity resources are not implemented yet",
    });
  }),
  ...
  runProjection: protectedProcedure
    ...
    .mutation(async () => {
      throw new TRPCError({
        code: "NOT_IMPLEMENTED",
        message: "Capacity projections are not implemented yet",
      });
    }),
});
