/**
 * InsurePortal -- Service Worker v5
 * Features: Web Push notifications, offline shell cache,
 * background sync for offline transaction queue, periodic sync.
 */
