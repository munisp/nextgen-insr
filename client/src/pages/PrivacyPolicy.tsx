...
const SECTIONS = [
  ...
  },
  {
    ...
    content: `InsurePortal Financial Services Limited is the data controller for personal data processed through this platform. Our registered address is: 1, Broad Street, Lagos Island, Lagos State, Nigeria. Data Protection Officer: dpo@insureportal.ng | +234 (0) 800 INSUREPORTAL.`,
  },
  {
      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-6 py-8">
        ...
        >
          <div className="text-sm font-bold text-white mb-1">
            InsurePortal Financial Services Limited — Privacy Policy
          </div>
        ...
        <div className="mt-8 text-center text-xs text-gray-500 pb-8">
          © 2026 InsurePortal Financial Services Limited. All rights reserved.
          <br />
