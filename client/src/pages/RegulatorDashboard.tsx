...
import { BarChart2, FileText, Scale, Shield, Activity, AlertTriangle, CheckCircle, DollarSign, TrendingUp } from "lucide-react";
...
export default function RegulatorDashboard() {
  ...
  const cards = [
    ...
    { title: "Market Penetration (%)", value: "—", icon: BarChart2, trend: "up" as const, trendValue: "↑ 0.3%", status: "neutral" as const, href: "/analytics-dashboard", accent: "var(--insurance-primary)" },
  ];
