...
// Named export for context.ts compatibility
export const fluvioClient = {
  connect: async () => { /* no-op: connection is lazy */ },
  produce: fluvioProduce,
  publishTransactionEvent,
  publishFraudAlertEvent,
  publishFloatEvent,
  publishKycEvent,
  getStats: getFluvioStats,
  shutdown: shutdownFluvio,
