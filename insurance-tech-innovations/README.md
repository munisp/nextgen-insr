...
Insurance technology innovation project tracker
...
| GET | `/api/v1/project?id=N` | Get by ID |
| POST | `/api/v1/projects/create` | Create new |
| DELETE | `/api/v1/projects/delete?id=N` | Delete by ID |
