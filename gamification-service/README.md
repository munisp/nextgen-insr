...
Gamification engine for customer engagement and retention
...
| GET | `/api/v1/event?id=N` | Get by ID |
| POST | `/api/v1/events/create` | Create new |
| DELETE | `/api/v1/events/delete?id=N` | Delete by ID |
