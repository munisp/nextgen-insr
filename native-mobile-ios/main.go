...
func initDB() {
	...
	log.Printf("Connected to PostgreSQL for native_mobile_ios")

	// Create table if not exists
	_, err = db.Exec(`CREATE TABLE IF NOT EXISTS native_mobile_ios (
...
func main() {
	...
	r.Get("/health", func(w http.ResponseWriter, r *http.Request) {
		json.NewEncoder(w).Encode(map[string]interface{}{
			"status": "healthy", "database": fmt.Sprintf("%v", db != nil), "service": "native-mobile-ios", "version": "1.0.0",
