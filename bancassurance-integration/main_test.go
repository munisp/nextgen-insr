...
func TestHealthEndpoint(t *testing.T) {
	...
	mux.HandleFunc("/health", func(w http.ResponseWriter, r *http.Request) {
		json.NewEncoder(w).Encode(map[string]string{"status": "healthy", "service": "bancassurance-integration"})
	})
	mux.ServeHTTP(w, req)
...
func Test_getProductName(t *testing.T) {
	// getProductName business logic test
	t.Log("Testing getProductName function")
