...
Mobile money payment integration for premium collection
...
| GET | `/api/v1/transaction?id=N` | Get by ID |
| POST | `/api/v1/transactions/create` | Create new |
| DELETE | `/api/v1/transactions/delete?id=N` | Delete by ID |
