...
export GRAFANA_DASHBOARD_UID=agent-dashboard-prod-v1
...
| `alertmanager.yml`              | `agent-dashboard-integration-token-change-in-production`         | Grafana OnCall webhook token    |
