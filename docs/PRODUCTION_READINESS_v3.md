...
- `infra/vault/policies/agent-dashboard.hcl` — POS Shell Vault policy
...
| `KEYCLOAK_CLIENT_ID`     | `agent-dashboard`                                                                               | `agent-dashboard`               |
| `KEYCLOAK_CLIENT_SECRET` | `agent-dashboard-secret-2026`                                                                   | Vault-injected            |
