...
|--------|------|-------------|
| GET | `/api/v1/feedbacks` | List all (paginated) |
| GET | `/api/v1/feedback?id=N` | Get by ID |
| POST | `/api/v1/feedbacks/create` | Create new |
| DELETE | `/api/v1/feedbacks/delete?id=N` | Delete by ID |
