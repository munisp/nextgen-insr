...
func initDB() {
	...
	log.Printf("Connected to PostgreSQL for insurance_mobile_app")

	// Create table if not exists
	_, err = db.Exec(`CREATE TABLE IF NOT EXISTS insurance_mobile_app (
...
func main() {
	...
	r.Get("/health", func(w http.ResponseWriter, r *http.Request) {
		json.NewEncoder(w).Encode(map[string]string{"status": "healthy", "database": db != nil, "service": "insurance-mobile-app"})
	})
