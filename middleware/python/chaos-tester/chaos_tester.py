#!/usr/bin/env python3
"""
InsurePortal Chaos Tester — Automated resilience testing for middleware stack.
...
class ChaosEngine:
    ...
    async def run_all(self, experiments: list[ChaosExperiment]):
        ...
        logger.info(f"=== InsurePortal Chaos Test Suite — {len(experiments)} experiments ===\n")
